...
(assert (let ((a!1 (= ((_ extract 64 64)
      ...
      (a!17 (not (= (ite main@%_48_0
                    ...
                    #x0000000000000000)))
      (a!21 (bvsle (bvadd main@%_42_0 main@%_3_0)
                   (ite (or (= main@%_4_0 #x0000000000000000) main@%_15_0)
                        #x0000000000000000
                        main@%_4_0)))
      (a!24 (bvsle main@%_3_0
                   (ite (or (= main@%_4_0 #x0000000000000000) main@%_15_0)
                        #x0000000000000000
                        main@%_4_0))))
...
(let ((a!7 (ite (bvule main@%_42_0
      ...
      (a!13 (ite main@%_86_0
                 (ite a!5
                      ...
                      (ite main@%_86_0
                           ...
                           (bvadd #xffffffffffffdfc0 sea.sp0_0)))
                 a!12))
      (a!18 (and (not (= main@%_42_0 #x0000000000000000))
                 (= (ite main@%_48_0
                         #x0000000000000000
                         (bvadd #xffffffffffffefc0 sea.sp0_0))
                    #x0000000000000000)
      ...
      (a!19 (and (bvule main@%_3_0 main@%_4_0)
                 (not (bvule #x000000000000000b main@%_4_0))
                 a!16
                 (not (bvule #x000000000000000b main@%_42_0))
                 (or (= main@%_42_0 #x0000000000000000) a!17))))
...
(let ((a!20 (ite (= a!8 #x0000000000000000)
                 (ite (= a!10 #x0000000000000000)
                      (ite (= a!14 #x0000000000000000) a!18 a!19)
                      a!19)
                 (ite (bvule a!10 a!8)
                      (ite (= a!14 #x0000000000000000) a!19 a!18)
                      a!19))))
(let ((a!22 (ite a!21
                 (ite (bvsle main@%_42_0
                      ...
                      a!19)
                 a!19))
      (a!23 (ite (bvsle (bvadd main@%_42_0 main@%_3_0) a!6)
                 (ite (bvsle main@%_42_0
                             (ite main@%_48_0
                                  #x0000000000000000
                                  #x000000000000000a))
                      ...
                      a!19)
                 a!19)))
(let ((a!25 (ite (= main@%_3_0 #x0000000000000000)
                 a!23
                 (ite (bvsle main@%_3_0 a!6) (ite a!24 a!23 a!19) a!19))))
(let ((a!26 (ite a!2
                 a!20
                 (ite (= main@%_3_0 (bvmul #xffffffffffffffff main@%_42_0))
                      a!19
                      (ite main@%_92_0 a!20 a!25)))))
(let ((a!27 (ite (bvule main@%_42_0
                        (bvadd main@%_4_0 (bvmul #xffffffffffffffff main@%_3_0)))
                 (ite (= main@%_42_0 #x0000000000000000) a!20 a!22)
                 (ite (= ((_ extract 64 64) a!4) #b0)
                      (ite (= a!3 #x0000000000000000)
                           a!19
                           (ite main@%_86_0 a!26 a!25))
                      a!20))))
