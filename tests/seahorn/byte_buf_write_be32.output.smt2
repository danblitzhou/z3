...
(assert (let ((a!1 (ite (or (= main@%_5_0 #x0000000000000000) main@%_16_0)
      ...
      (a!2 (bvsle (bvadd #x0000000000000001 main@%_45_0)
                  (ite (or (= main@%_5_0 #x0000000000000000) main@%_16_0)
                       #x0000000000000000
                       main@%_5_0)))
      (a!3 (bvsle (bvadd #x0000000000000004 main@%_4_0)
                  (ite (or (= main@%_5_0 #x0000000000000000) main@%_16_0)
                       #x0000000000000000
                       main@%_5_0)))
      (a!8 (ite (bvsle #x0000000000000000 main@%_4_0)
                (ite (bvule (bvadd #x0000000000000004 main@%_4_0) main@%_5_0)
                     (bvadd #x0000000000000004 main@%_4_0)
...
(let ((a!16 (ite (or (= main@%_4_0 #x0000000000000000)
                 ...
                 (and a!7 (not a!10))
                 a!15)))
(let ((a!17 (ite (bvule (bvadd #x0000000000000004 main@%_4_0) main@%_5_0)
