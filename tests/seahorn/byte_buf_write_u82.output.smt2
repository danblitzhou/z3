...
(assert (let ((a!1 (bvsle (bvadd #x0000000000000001 main@%_2_0)
                  (ite (or (= main@%_3_0 #x0000000000000000) main@%_14_0)
                       #x0000000000000000
                       main@%_3_0)))
      (a!2 (ite (bvsle #x0000000000000000 main@%_2_0)
                (ite (bvule main@%_3_0 main@%_2_0)
                     main@%_2_0
                     (bvadd #x0000000000000001 main@%_2_0))
                main@%_2_0))
...
(let ((a!6 (ite (= a!2 #x0000000000000000)
      ...
      (a!7 (ite (bvule a!2 main@%_3_0)
                ...
                (and (bvule main@%_2_0 main@%_3_0)
                     (not (bvule #x000000000000000b main@%_3_0))
                     a!5))))
(let ((a!8 (ite (or (bvule main@%_3_0 main@%_2_0) a!1)
  ...
  (and (= #b000 ((_ extract 2 0) sea.sp0_0))
       ...
       (ite (bvsle #x0000000000000000 main@%_2_0)
            a!8
            (ite (= main@%_3_0 #x0000000000000000) a!6 a!7)))))))))
(check-sat)
